  ...
  return (
    <div className="h-screen px-[0px] max-w-full mx-auto flex flex-col items-center relative">
      <div className="wrap_full_game">
        ...
        <div className="bg-[#151b2e] rounded-[1rem] py-[.9rem] px-[1rem] flex justify-between flex-col relative">
          <img
            src={footerImage}
            alt=""
            className="absolute -z-10 top-[51%] max-w-[90000px] -left-5 w-screen"
          />
          <div className="bg-[#0a0d2c] w-full rounded-[8px] px-[1.25rem] py-2 mb-[.75rem]">
            <div className="flex items-center">
              ...
              <input
                ...
                className={`bg-transparent outline-none text-white font-HalvarBreitBd text-center`}
              />
              <span
